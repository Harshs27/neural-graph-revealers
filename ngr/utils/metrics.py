...
def compute_metrics(preds, labels):
    ...
    rel_err = mean_absolute_percentage_error(labels,preds)
...
def graph_compare_metrics(trueG, G, beta=1):
    """Compute various metrics
    Args:
        trueG (2D numpy arr[floats]): ground truth adj mat
        G (2D numpy arr[floats]): predicted adj mat
